    ...
    <div>
      <div>
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 relative top-[-7rem] sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  <div className="">
                    <div className="mx-auto relative top-[-5rem] max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                      ...
                      <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {products?.map((product) => (
                          <div>
                            <Link
                              to={`/admindashboard/product/product-photo/${product._id}`}
                              key={product._id}
                            >
